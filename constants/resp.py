...
{}```Join the official support server: https://discord.gg/PVTBgK6 \nSee the code for yourself: https://github.com/spergmoment/law-enforcer \
\nNOTE: The above repository is an old, public version. The private, current version will be released eventually."
